...
class M:
    ...
    TORRENT_MODE_PROMPT = "torrent_mode_prompt"
    TORRENT_BTN_SEARCH = "torrent_btn_search"
    TORRENT_BTN_PROVIDE = "torrent_btn_provide"
    TORRENT_PROVIDE_PROMPT = "torrent_provide_prompt"
    TORRENT_MAGNET_ACK = "torrent_magnet_ack"
    DDL_PROVIDE_PROMPT = "ddl_provide_prompt"
    DDL_LINK_ACK = "ddl_link_ack"
    TORRENT_FILE_ACK = "torrent_file_ack"
    TORRENT_BTN_CONFIRM = "torrent_btn_confirm"
    ...
    TORRENT_MAP_BTN_FIX = "torrent_map_btn_fix"
    TORRENT_MAP_TOGGLE_TITLE = "torrent_map_toggle_title"
    TORRENT_MAP_TOGGLE_HELP = "torrent_map_toggle_help"
    TORRENT_MAP_EDIT_TITLE = "torrent_map_edit_title"
    TORRENT_MAP_EDIT_HELP = "torrent_map_edit_help"
    TORRENT_MAP_BTN_JUNK = "torrent_map_btn_junk"
    TORRENT_MAP_FIX_PROMPT = "torrent_map_fix_prompt"
    TORRENT_MAP_FIX_ACK = "torrent_map_fix_ack"
    TORRENT_MAP_FIX_APPLY = "torrent_map_fix_apply"
    TORRENT_MAP_NO_FRANCHISE = "torrent_map_no_franchise"
